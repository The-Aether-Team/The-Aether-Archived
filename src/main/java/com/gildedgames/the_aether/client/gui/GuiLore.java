...
public class GuiLore extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (searchedStack != null) {
            ...
            for (String name : ((List<String>) this.fontRendererObj.listFormattedStringToWidth(
            ...
            for (String lore : ((List<String>) this.fontRendererObj
                .listFormattedStringToWidth(this.stringToLoad, 109))) {
