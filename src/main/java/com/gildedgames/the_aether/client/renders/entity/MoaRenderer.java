...
public class MoaRenderer extends RenderLiving {
    ...
    private static final ResourceLocation TEXTURE_OUTSIDE = Aether
        .locate("textures/entities/moa/canvas/moa_outside.png");
    ...
    private static final ResourceLocation TEXTURE_MARKINGS = Aether
        .locate("textures/entities/moa/canvas/moa_markings.png");

    private static final ResourceLocation TEXTURE_WING = Aether.locate("textures/entities/moa/canvas/moa_wing.png");

    private static final ResourceLocation TEXTURE_WING_MARKINGS = Aether
        .locate("textures/entities/moa/canvas/moa_wing_markings.png");

    private static final ResourceLocation TEXTURE_UNCHANGED = Aether
        .locate("textures/entities/moa/canvas/moa_unchanged.png");
    ...
    private static final ResourceLocation RAPTOR = new ResourceLocation(
        "aether_legacy",
        "textures/entities/moa/raptor.png");
    ...
    @Override
    protected void renderModel(EntityLivingBase entity, float p_77036_2_, float p_77036_3_, float p_77036_4_,
        ...
        if (!entity.isInvisible()) {
            ...
            this.mainModel
                .setRotationAngles(p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_, entity);
        }
    }
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        ...
        if (moa.hasCustomNameTag() && "Mos".equals(moa.getCustomNameTag())
            ...
            return MOS;
        } else if (moa.hasCustomNameTag() && "Raptor__".equals(moa.getCustomNameTag())
            && (moa.getMoaType() == AetherMoaTypes.blue)) {
                return RAPTOR;
            } else {
                return moa.getMoaType()
                    .getTexture(moa.isSaddled(), moa.riddenByEntity != null);
            }
    }
