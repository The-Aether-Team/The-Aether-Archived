...
public class BlockAetherGrass extends Block implements IGrowable, IAetherMeta
{
	...
	public BlockAetherGrass()
	{
		...
		this.setDefaultState(this.getDefaultState()
			...
			.withProperty(dungeon_block, Boolean.FALSE)
			.withProperty(double_drop, Boolean.TRUE)
			.withProperty(variant, EnumGrassType.Aether));
	}
	...
	public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
	{
		world.setBlockState(pos, state
				.withProperty(double_drop, Boolean.FALSE)
				.withProperty(dungeon_block, Boolean.FALSE));
	}
	...
	public IBlockState getStateFromMeta(int meta)
	{
		return this.getDefaultState()
				.withProperty(double_drop, (meta & 1) == 0)
	...
	{
		return new BlockStateContainer(this, double_drop, SNOWY, dungeon_block, variant);
	}
