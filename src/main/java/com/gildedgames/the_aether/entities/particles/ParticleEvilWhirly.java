...
public class ParticleEvilWhirly extends AetherParticle {
    ...
    public ParticleEvilWhirly(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double p_i46347_8_,
    ...
    public ParticleEvilWhirly(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double p_i46348_8_,
     ...
     */
    public void renderParticle(Tessellator worldRendererIn, float partialTicks, float rotationX, float rotationZ,
