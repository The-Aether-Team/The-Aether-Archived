...
public class AetherGenFruitTree extends WorldGenAbstractTree
{
	...
	public AetherGenFruitTree(IBlockState leaves, IBlockState fruit, int fruitChance, int heightWeight, boolean branchFlag, boolean notify)
	{
		super(notify);
	...
	public boolean generate(World world, Random random, BlockPos position)
	{
		...
		if (y + (height + 2) <= world.getActualHeight() && cangen)
		{
			...
			IBlockState air = Blocks.AIR.getDefaultState(),
					wall = BlocksAether.skyroot_wall.getDefaultState().withProperty(BlockSkyrootWall.PROPERTY_GENERATED, true),
					log = BlocksAether.aether_log.getDefaultState();
