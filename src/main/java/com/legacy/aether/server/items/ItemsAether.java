...
import com.legacy.aether.server.items.armor.ItemZaniteArmor;
import com.legacy.aether.server.items.dungeon.ItemDungeonKey;
import com.legacy.aether.server.items.food.ItemAetherFood;
import com.legacy.aether.server.items.food.ItemAmbrosiumShard;
import com.legacy.aether.server.items.food.ItemGummySwet;
...
import com.legacy.aether.server.items.tools.ItemZaniteTool;
import com.legacy.aether.server.items.util.EnumAetherToolType;
import com.legacy.aether.server.items.util.ItemAether;
import com.legacy.aether.server.items.weapons.ItemCandyCaneSword;
...
import com.legacy.aether.server.items.weapons.ItemValkyrieLance;
import com.legacy.aether.server.items.weapons.ItemVampireBlade;
import com.legacy.aether.server.items.weapons.ItemZaniteSword;
import com.legacy.aether.server.items.weapons.projectile.ItemDart;
import com.legacy.aether.server.items.weapons.projectile.ItemDartShooter;
import com.legacy.aether.server.items.weapons.projectile.ItemPhoenixBow;
