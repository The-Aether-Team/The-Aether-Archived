...
public class MapGenColdAercloud extends MapGenStructure
{

    public MapGenColdAercloud()
    {
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        private void create(World worldIn, Random random, int chunkX, int chunkZ)
        {
            ...
            this.components.add(new ComponentColdAercloud((chunkX << 4) + 2, random.nextInt(64) + 64, (chunkZ << 4) + 2, this.xTendency, this.zTendency));
