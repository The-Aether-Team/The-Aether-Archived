...
public class AetherMainMenu extends GuiMainMenu {
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        this.buttonList
            .add(new AetherMainMenuButton(1, 30, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(
            new AetherMainMenuButton(
                2,
                30,
        ...
        this.buttonList.add(
            new AetherMainMenuButton(0, 30, p_73969_1_ + p_73969_2_ * 4, I18n.format("menu.options", new Object[0])));
        this.buttonList
            .add(new AetherMainMenuButton(4, 30, p_73969_1_ + p_73969_2_ * 5, I18n.format("menu.quit", new Object[0])));
    }
            ...
            if ((this.buttonList.get(j)) instanceof AetherMainMenuButton) {
                if (((GuiButton) this.buttonList.get(j)).func_146115_a()) {
                    if (((GuiButton) this.buttonList.get(j)).xPosition < 45) {
                        ((GuiButton) this.buttonList.get(j)).xPosition = ((GuiButton) this.buttonList.get(j)).xPosition
                            + 4;
                    }
                } else {
