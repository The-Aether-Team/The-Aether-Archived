...
public class ComponentSilverDungeon extends AetherStructure {
                                    ...
                                    if (this.getBlockState(u, 5 * q + 1, v)
                                        ...
                                        if (tileEntity instanceof TileEntityChest) {
                                            for (u = 0; u < 3 + random.nextInt(3); u++) {
                                                ((TileEntityChest) tileEntity).setInventorySlotContents(
                                                    this.random
                                                        .nextInt(((TileEntityChest) tileEntity).getSizeInventory()),
    ...
    private ItemStack getNormalLoot(Random random) {
        ...
        switch (item) {
            ...
            case 12: {
                if (random.nextInt(2) == 0) return new ItemStack(ItemsAether.zanite_boots);
                if (random.nextInt(2) == 0) return new ItemStack(ItemsAether.zanite_helmet);
                if (random.nextInt(2) == 0) return new ItemStack(ItemsAether.zanite_leggings);
                if (random.nextInt(2) == 0) return new ItemStack(ItemsAether.zanite_chestplate);
                break;
            }
            case 13: {
                if (random.nextInt(4) == 0) return new ItemStack(ItemsAether.iron_pendant);
            }
            case 14: {
                if (random.nextInt(10) == 0) return new ItemStack(ItemsAether.golden_pendant);
            }
            case 15: {
                if (random.nextInt(15) == 0) return new ItemStack(ItemsAether.zanite_ring);
            }
        }
    ...
    public static ItemStack getSilverLoot(Random random) {
        ...
        switch (item) {
            ...
            case 2: {
                if (random.nextBoolean()) return new ItemStack(ItemsAether.valkyrie_axe);
                if (random.nextBoolean()) return new ItemStack(ItemsAether.valkyrie_shovel);
                if (random.nextBoolean()) return new ItemStack(ItemsAether.valkyrie_pickaxe);
                break;
            }
            case 3:
            ...
            case 6: {
                if (random.nextBoolean()) return new ItemStack(ItemsAether.neptune_helmet);
                if (random.nextBoolean()) return new ItemStack(ItemsAether.neptune_leggings);
                if (random.nextBoolean()) return new ItemStack(ItemsAether.neptune_chestplate);
                break;
            }
            case 7: {
                if (random.nextBoolean()) return new ItemStack(ItemsAether.neptune_boots);
                return new ItemStack(ItemsAether.neptune_gloves);
            }
            case 8: {
                if (random.nextBoolean()) return new ItemStack(ItemsAether.valkyrie_boots);
                return new ItemStack(ItemsAether.valkyrie_gloves);
            }
            case 9:
                return new ItemStack(ItemsAether.valkyrie_leggings);
            case 10:
                if (random.nextBoolean()) return new ItemStack(ItemsAether.valkyrie_chestplate);
            case 11:
                if (random.nextBoolean()) return new ItemStack(ItemsAether.valkyrie_boots);
                return new ItemStack(ItemsAether.valkyrie_gloves);
            case 12:
