...
public abstract class AetherTileEntity extends TileEntity implements ISidedInventory, IInventory {
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        for (int i = 0; i < list.tagCount(); ++i) {
            ...
            if (slot >= 0 && slot < this.getTileInventory()
                .size()) {
    ...
    public void writeToNBT(NBTTagCompound compound) {
        ...
        for (int i = 0; i < this.getTileInventory()
            .size(); ++i) {
            ItemStack stack = this.getTileInventory()
                .get(i);
