...
public class AetherBiomeDecorator extends BiomeDecorator {
    ...
    protected void genDecorations(BiomeGenBase biome) {
        ...
        if (this.shouldSpawn(37)) {
            this.crystal_island
                .generate(this.world, this.rand, this.chunk_X + 8, this.nextInt(64) + 32, this.chunk_Z + 8);
        }
        ...
        if (AetherConfig.tallgrassEnabled()) {
            for (int i3 = 0; i3 < 10; ++i3) {
                ...
                if (k14 > 0) {
                    ...
                    this.aetherBiome.getRandomWorldGenForGrass(this.rand)
                        .generate(this.world, this.rand, j7, l17, i11);
                }
            }
