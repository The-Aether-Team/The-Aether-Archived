...
public class AetherEntityEvents {
        ...
        if (entity.riddenByEntity != null) {
            if (entity.riddenByEntity.isRiding()) {
                if (entity.dimension == AetherConfig.getAetherDimensionID() && !entity.worldObj.isRemote) {
                    ...
                    int transferDimension = previousDimension == AetherConfig.getAetherDimensionID() ? 0
    ...
    public static void transferEntity(boolean shouldSpawnPortal, Entity entity, WorldServer previousWorldIn,
