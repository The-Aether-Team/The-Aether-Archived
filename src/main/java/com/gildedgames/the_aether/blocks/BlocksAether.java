...
public class BlocksAether
{
	...
	public static void initializeHarvestLevels()
	{
		...
		BlocksAether.aether_grass_path.setHarvestLevel("shovel", 0);
		...
		BlocksAether.skyroot_wall.setHarvestLevel("axe", 0);
		...
		BlocksAether.ambrosium_lamp.setHarvestLevel("pickaxe", 0);
	}
