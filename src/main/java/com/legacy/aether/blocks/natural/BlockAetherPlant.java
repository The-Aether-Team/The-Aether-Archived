...
public class BlockAetherPlant extends Block implements IGrowable
{
	...
	{
		return state.getBlock() == BlocksAether.aether_grass || state.getBlock() == BlocksAether.aether_dirt || state.getBlock() == BlocksAether.enchanted_aether_grass;
	}
	...
	{
		if (playerIn.getHeldItemMainhand().getItem() == ItemsAether.gummy_swet)
		{
