...
{	
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (aether)
        {
        	this.drawCenteredString(this.fontRenderer, "Ascending to the Aether", this.width / 2, this.height / 2 - 45, 16777215);
        ...
        {
        	this.drawCenteredString(this.fontRenderer, "Decending from the Aether", this.width / 2, this.height / 2 - 45, 16777215);
        	this.drawCenteredString(this.fontRenderer, I18n.format("multiplayer.downloadingTerrain"), this.width / 2, this.height / 2 - 25, 16777215);
        }
